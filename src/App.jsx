...
export default function App() {
  ...
  the UI to wiring up APIs and databases. Beyond web dev, I'm actively
  exploring Artificial Intelligence & Data Science, which is where I see
  my future headed. I recently completed a Web Development{" "}
  <span style={{ color: GRAD1, fontWeight: 700 }}>Internship</span> at
  Drops of Change Welfare NGO, where I built and maintained web solutions
  for social welfare initiatives. At college, I'm also a Technical Team
