...
const PROJECTS = [
  {
    ...
    github: "https://github.com/vaishnaviimahajann/ChatVerse",
...
export default function App() {
  return (
    <div style={{ background: T.bg, color: T.text, minHeight: "100vh", overflowX: "hidden", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Inter, sans-serif" }}>
      ...
      >
        <span className="navbar-name" style={{ fontWeight: 700, fontSize: "16px", letterSpacing: "-0.01em" }}>Vaishnavi Mahajan</span>
        <div className="navbar-links" style={{ display: "flex", gap: "16px", alignItems: "center", flexWrap: "wrap" }}>
          {NAV.map((n) => (
      ...
      <section id="home" className="section" style={{ maxWidth: "720px", margin: "0 auto", padding: "90px 24px 60px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <h1 style={{ fontSize: "clamp(28px, 5vw, 44px)", fontWeight: 800, margin: "0 0 12px", letterSpacing: "-0.02em", lineHeight: 1.15 }}>
          Hi, I'm Vaishnavi —{" "}
  ...
  real-world web applications.
            ...
            <p style={{ margin: "0 0 14px" }}>
              ...
              wiring up APIs and databases.
            </p>
            <p style={{ margin: "0 0 14px" }}>
              Beyond web dev, I'm actively exploring Artificial Intelligence
              & Data Science, which is where I see my future headed.
            </p>
            <p style={{ margin: "0 0 14px" }}>
